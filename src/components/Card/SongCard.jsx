...
const SongCard = ({ image_url, name, artist, duration, playSong }) => {
  return (
    <>
      <div className="search--songs-card d-flex justify-content-between align-items-center p-1 rounded-2">
        ...
        <div className="d-flex align-items-center me-3">
          ...
          <span className="me-1 me-sm-2">{duration}</span>
